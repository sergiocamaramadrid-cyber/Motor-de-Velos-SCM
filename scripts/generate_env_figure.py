#!/usr/bin/env python3
"""
Generate environment correlation figure for SCM framework.

Reads a CSV containing:
    - galaxy
    - F3 or delta_f3
    - environmental proxy (e.g., delta_mass or delta_mass_yang)

Produces:
    docs/paper1/figures/figure_env_correlation.pdf

Behavior:
    - Auto-detects available columns
    - Computes Spearman correlation
    - Saves fallback file if input is missing
"""
